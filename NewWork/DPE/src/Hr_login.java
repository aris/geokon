...
public class Hr_login extends JFrame {
	...
	private JButton Lbutton = new JButton("ΕΙΣΟΔΟΣ");
	...
	public void Hr_login1(){
		...
		JLabel HrLabel = new JLabel("Όνομα:");
		...
		JLabel HrLabel1 = new JLabel("Κωδικός:");
		...
		JButton Εbutton = new JButton("ΕΞΟΔΟΣ");
		
		Εbutton.setFont(new Font("Serif", Font.CENTER_BASELINE, 13));
		Εbutton.setBounds(190, 223, 95, 25);
		Panel.add(Εbutton);
					
		Εbutton.addActionListener(new ActionListener() {
	...
	public void actionlogin(){
		...
		public void actionPerformed(ActionEvent arg0) {
			try {
				...
				if(count==1)
				{		
					JOptionPane.showMessageDialog(null, "Επιτυχία Εισόδου !");
					dispose();					
					Hr_Properties hr = new Hr_Properties();
					hr.setVisible(true);
				}			
				else{				
					JOptionPane.showMessageDialog(null, "Λάθος Χρήστης ή κωδικός !");
					HrText.setText("");
					HrPass.setText("");
				}
				rs.close();
				...
				JOptionPane.showMessageDialog(null, "Δεν υπάρχει σύνδεση στη βάση !");
			}
		}
