...
public class Ceo_valuation extends JFrame  {
	...
	public Ceo_valuation()  {
		...
		JLabel label_2 = new JLabel("¡Œ…œÀœ√«”«");
		...
		Create.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {				
				...
				try{				
					...
					ps.executeUpdate();
					ps.close();											
					JOptionPane.showMessageDialog(null, "¡ÓÈÔÎ¸„ÁÛÁ = "+item+" !");				
					 con.close();					
					}catch (Exception ex){						
						JOptionPane.showMessageDialog(null, "¡ÔÙı˜ﬂ· ¡ÓÈÔÎ¸„ÁÛÁÚ !");			
					}}
		...
		Del.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {														
					...
					try{				
						...
						ps.executeUpdate();
						ps.close();											
						JOptionPane.showMessageDialog(null, " ∏„ÍıÒÁ ƒÈ·„Ò·ˆﬁ ¡ÓÈÔÎ¸„ÁÛÁÚ !");				
						 con.close();					
						}catch (Exception ex){						
							JOptionPane.showMessageDialog(null, "¡ÔÙı˜ﬂ· ƒÈ·„Ò·ˆﬁÚ ·ÓÈÔÎ¸„ÁÛÁÚ !");			
						}}
